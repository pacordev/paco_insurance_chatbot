# Technical Details — Insurance Knowledge Assistant

This is the deep-dive companion to the [main README](../README.md): why the project exists, its current status, the full tech stack, the file-by-file breakdown, how to run it, and its known limitations.
...
```
ins_chatbot/
├── README.md                 # project overview — start there
...
├── docs/                       # this file, plus the interactive architecture diagram
│   ├── TECHNICAL.md
│   ├── ins_chatbot_architecture.html
│   └── ins_chatbot_architecture.visual-check.json
